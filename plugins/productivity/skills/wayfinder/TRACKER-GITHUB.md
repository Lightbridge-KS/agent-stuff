...
How a wayfinder map, its child tickets, blocking, claiming, and the frontier query are expressed on GitHub Issues. The **map** is a single issue with **child** issues as tickets.
